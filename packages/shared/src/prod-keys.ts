/**
 * assertProdKeys — the boot-time fail-loud for the OpenAI/Firecrawl secrets the live cascade + worker require.
 *
 * The per-call clients (lib/openai, lib/firecrawl) throw at the seam, but the best-effort retry loops in LiveNarrator /
 ...
 */
export const REQUIRED_PROD_KEYS = ['OPENAI_API_KEY', 'FIRECRAWL_API_KEY'] as const
